# -*- coding: utf-8 -*-
"""Distributed Belief Propagation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1iOQfTeEFERNwIOLp0eDI6saas9Fi-AFc
"""
...
node_features = node_features[0:200].to_numpy(dtype='float32')

X_train, X_test, y_train, y_test = train_test_split(node_features_filtered[:200], labels_filtered[:200], test_size=0.25, random_state=4)
...
unique, counts = np.unique(labels[0:200], return_counts=True)
...
est = Estimator.from_keras(model_creator=model_creator, workers_per_node=1,backend="ray")
